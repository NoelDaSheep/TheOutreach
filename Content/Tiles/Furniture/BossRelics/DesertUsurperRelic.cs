...
namespace TheOutreach.Content.Tiles.Furniture.BossRelics
{
	...
	public class DesertUsurperRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "TheOutreach/Content/Tiles/Furniture/BossRelics/DesertUsurperRelic";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "TheOutreach/Content/Tiles/Furniture/BossRelics/RelicPedestal";
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			...
			{
				case 0:
					itemType = ModContent.ItemType<Items.Placeable.Furniture.BossRelics.DesertUsurperRelic>();
					break;
