...
namespace TheOutreach.Content.Tiles
{
	public class LithiumOre : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			AddMapEntry(new Color(134, 162, 135), name);

			DustType = 84;
			ItemDrop = ModContent.ItemType<Items.Placeable.LithiumOre>();
	...
	public class LithiumOreSystem : ModSystem
	{
		public override void ModifyWorldGenTasks(List<GenPass> tasks, ref float totalWeight)
		{
			...
			if (ShiniesIndex != -1)
			{
				...
				tasks.Insert(ShiniesIndex + 1, new LithiumOrePass("The Outreach Ores", 237.4298f));
			}
		}
	}
	...
	public class LithiumOrePass : GenPass
	{
		...
		protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration)
		{
			...
			progress.Message = "The Outreach Ores";
			...
			for (int k = 0; k < (int)(Main.maxTilesX * Main.maxTilesY * 6E-05); k++)
			{
				...
				WorldGen.TileRunner(x, y, WorldGen.genRand.Next(6, 12), WorldGen.genRand.Next(4, 12), ModContent.TileType<LithiumOre>());
