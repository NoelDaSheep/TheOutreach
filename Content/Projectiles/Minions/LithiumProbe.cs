...
namespace TheOutreach.Content.Projectiles.Minions
{
	...
	public class LithiumProbe : ModProjectile
	{

		public int ShootCoolMax = 50;
		public int ShootCool = 50;
		...
		public override void AI()
		{
			...
			if (owner.setBonus == "" || owner.setBonus != "n+1 minion slot" + "\nSummons a really dumb robot to protect you")
			{
				owner.ClearBuff(ModContent.BuffType<LithiumProbeBuff>());
			}
			if (owner.HasBuff(ModContent.BuffType<LithiumProbeBuff>()))
			{
			...
			ShootCool--;
			if (foundTarget == true && ShootCool <= 0)
            {
		...
		private void Visuals()
		{
			...
			// Some visuals here
			Lighting.AddLight(Projectile.Center, Color.CornflowerBlue.ToVector3() * 0.20f);
		}

		/*public override bool PreDraw(ref Color drawColor)
		{
			Main.EntitySpriteDraw(Request<Texture2D>("TheOutreach/Content/Projectiles/Minions/LithiumProbe_Glowmask").Value, new Vector2(Projectile.Center.X - Main.screenPosition.X, Projectile.Center.Y - Main.screenPosition.Y),
