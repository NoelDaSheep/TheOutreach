...
{
	public class SkelecircleDrawLayer : PlayerDrawLayer
	{
		private Asset<Texture2D> Skelecircle;
		...
		public override bool GetDefaultVisibility(PlayerDrawSet drawInfo) {
			...
			return drawInfo.drawPlayer.GetModPlayer<ExampleDashPlayer>().isdashing;
		...
		protected override void Draw(ref PlayerDrawSet drawInfo) {
			...
			if (Skelecircle == null) {
				Skelecircle = ModContent.Request<Texture2D>("TheOutreach/Assets/Effects/Skelecircle");
			}
			...
			drawInfo.DrawDataCache.Add(new DrawData(
				Skelecircle.Value, // The texture to render.
				position, // Position to render at.
				null, // Source rectangle.
				Color.White, // Color.
				0f, // Rotation.
				Skelecircle.Size() * 0.5f, // Origin. Uses the texture's center.
				1f, // Scale.
